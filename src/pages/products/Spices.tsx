...
const Spices = () => {
  ...
  const spiceProducts = getProductsByCategory('spices');
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-r from-[#2A2A6F] via-[#5353AB] to-[#362F6F] text-white py-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h1 className="text-4xl lg:text-5xl font-bold mb-4">Aromatic Spices</h1>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-2">
                      <Button 
                        ...
                        onClick={() => navigate(`/products/spices/${product.subcategory || 'general'}/${product.id}`)}
                      >
                        View Details
                      </Button>
                      <Button 
