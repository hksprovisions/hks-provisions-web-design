...
const Wheat = () => {
  ...
  const wheatProducts = getProductsByCategory('wheat');
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-r from-[#2A2A6F] via-[#5353AB] to-[#362F6F] text-white py-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h1 className="text-4xl lg:text-5xl font-bold mb-4">Premium Wheat Products</h1>
          <p className="text-xl opacity-90 max-w-3xl">
            High-quality wheat varieties sourced from India's premier wheat-growing regions. 
                ...
                <CardContent className="p-0">
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4">
                      <Badge className="bg-[#5353AB] text-white">{product.category}</Badge>
                    </div>
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-2">
                      <Button 
                        ...
                        onClick={() => navigate(`/products/wheat/general/${product.id}`)}
                      >
                        View Details
                      </Button>
                      <Button 
