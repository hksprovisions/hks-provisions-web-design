    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-r from-[#2A2A6F] via-[#5353AB] to-[#362F6F] text-white py-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h1 className="text-4xl lg:text-5xl font-bold mb-4">Premium Tea Products</h1>
          <p className="text-xl opacity-90 max-w-3xl">
            Finest quality tea sourced from renowned tea gardens across India. 
            From robust Assam CTC to delicate orthodox varieties, perfect for global tea markets.
          </p>
        </div>
      </section>
