...
const WhyHKS = () => {
  const benefits = [
    ...
    {
      icon: <Truck className="w-12 h-12 text-[#5353AB]" />,
    ...
    {
      icon: <DollarSign className="w-12 h-12 text-[#5353AB]" />,
    ...
    {
      icon: <Clock className="w-12 h-12 text-[#5353AB]" />,
    ...
    {
      icon: <Award className="w-12 h-12 text-[#5353AB]" />,
  ...
  return (
    <section id="why-hks" className="py-20 bg-gradient-to-br from-[#2A2A6F] to-[#362F6F] text-white">
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold mb-4 group-hover:text-[#DEDDF5] transition-colors">
                  {benefit.title}
                </h3>
                ...
                <div className="space-y-2">
                  {benefit.details.map((detail, idx) => (
                    <div key={idx} className="flex items-center justify-center text-sm">
                      <div className="w-2 h-2 bg-[#5353AB] rounded-full mr-2"></div>
        ...
        <div className="text-center mt-16">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-4xl mx-auto border border-white/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button 
                className="bg-[#5353AB] hover:bg-[#DEDDF5] hover:text-[#2A2A6F] text-white px-8 py-4 rounded-lg font-semibold transition-all transform hover:scale-105 shadow-xl"
                onClick={() => window.open('https://wa.me/917397248389?text=Hi%2C%20I%20want%20to%20partner%20with%20HKS%20Provisions', '_blank')}
              >
                Get Started Today
              </button>
              <button 
                className="border-2 border-white text-white hover:bg-white hover:text-[#2A2A6F] px-8 py-4 rounded-lg font-semibold transition-all transform hover:scale-105"
